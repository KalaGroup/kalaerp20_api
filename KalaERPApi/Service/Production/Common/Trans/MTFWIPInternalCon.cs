    ...
    public class MTFWIPInternalCon
    {
        ...
        public DataTable GetReqDetails(string PCCode, string strBomCode, string StrReqCode, double StrReqQty, double StrMTFQty)
        {
            ...
            strProc = "select Partdesc+'-->'+R.Partcode as PartDesc,R.Partcode as PartCode,UName,Uid,0.000 as KitQty,Round(Qty,3) as ReqQty, " +
                                 ...
                                 " 0.00 as Amt,0.000 as SheetQty,P.ConvUOMCode,P.Length,P.Width,P.Thickness,P.MOB  " +
            ...
            if (dsFillData.Tables["TempProcess"].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dsFillData.Tables["TempProcess"].Rows.Count; i++)
                {
                   ...
                   //B
                        ...
                        dsFillData.Tables["TempProcess"].Rows[i]["Rate"] = Math.Round(getPtRate(PCCode.Trim() ,dsFillData.Tables["TempProcess"].Rows[i]["MOB"].ToString().Trim(),dsFillData.Tables["TempProcess"].Rows[i]["Partcode"].ToString().Trim(),
        ...
        protected double getPtRate(string StrPCCode, string StrMOB,string PartCode, string ConversionValue, string UOMCode)
        {
            double tempRate = 0;
            ...
            else //M
            {
                ...
                strProc = "";
                strProc = "Select top 1 Rate from ProfitCenterPLDetails  WHERE PartCode='" + PartCode.Trim() + "' and  ProfitCenterCode='" + StrPCCode.Trim() + "'";
                cmd = new SqlCommand(strProc, con);
                adapter.SelectCommand = cmd;
                adapter.Fill(dsPtRate, "ProfitCenterPLDetails");
                cmd.Dispose();



                if (dsPtRate.Tables["ProfitCenterPLDetails"].Rows.Count > 0)
                {
                    tempRate = double.Parse(dsPtRate.Tables["ProfitCenterPLDetails"].Rows[0]["Rate"].ToString().Trim());
                }
            }
            return tempRate;
        }
        ...
        protected double getWipStock(string PartCode, int StockType)
        {
            ...
            return tempRecQty - tempIssueQty;
             ...
             public DataTable GetSerialNoDateWise(string CompCode, string FromDt, string ToDt)
        {
            ...
            for (int cSubV = 0; cSubV <= recCountV; cSubV++)
            {
                ...
                if (DtsV[0].Trim().Substring(0, 3) == "001" || DtsV[0].Trim().Substring(0, 3) == "002" || DtsV[0].Trim().Substring(0, 3) == "010")
                {
                    ...
                    //dsDetailsSubV = ComCon.procTranDS("exec MTFSRNo '" + DtsV[0] + "'," + DtsV[1].Trim() + "", "tbl_MTFSrNoV", con, tran);
                      dsDetailsSubV = ComCon.procTranDS("exec MTFSRNo_AgainstJobcard '" + DtsV[0] + "'," + DtsV[1].Trim() + ", '" + MTFWIPIntreq.ReqCode.Trim() + "'", "tbl_MTFSrNoV", con, tran);
                    if (dsDetailsSubV != null && dsDetailsSubV.Tables["tbl_MTFSrNoV"].Rows.Count > 0)
                    {
                        ...
                        //Math.Round(double.Parse(DtsV[1].Trim()), 2)
                        else if (Math.Round(double.Parse(DtsV[1].Trim()), 0) > strBatQty && DtsV[0].ToString().Substring(0, 3) == "010")
                        {
                ...
                else
                {
                    ...
                    if (MTFWIPIntreq.FromPCCode.Trim().Substring(0, 2).Trim() == "23"
                    &&
            ...
            try
            {
                ...
                for (int cSub = 0; cSub <= recCount; cSub++)
                {
                    ...
                    if (Dts[0].Trim().Substring(0, 3) == "001" || Dts[0].Trim().Substring(0, 3) == "002" || Dts[0].Trim().Substring(0, 3) == "010")
                    {
                        ...
                        dsDetailsSub = ComCon.procTranDS("exec MTFSRNo_AgainstJobcard '" + Dts[0] + "'," + Dts[1].Trim() + ", '" + MTFWIPIntreq.ReqCode.Trim() + "'", "tbl_MTFSrNo", con, tran);

                       // ComCon.procTranDS("exec MTFSRNo_AgainstJobcard '" + Dts[0] + "'," + Dts[1].Trim() + ", '" + MTFWIPIntreq.ReqCode.Trim() + "'", "tbl_MTFSrNoV", con, tran);
                        if (dsDetailsSub != null && dsDetailsSub.Tables["tbl_MTFSrNo"].Rows.Count > 0)
                        {
                            ...
                            for (int k = 0; k < dsDetailsSub.Tables["tbl_MTFSrNo"].Rows.Count; k++)
                            {
                                ...
                                if (dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["GCode"].ToString().Trim().Substring(0, 3) == "GIR")
                                {
                                    sb.Remove(0, sb.Length);
                                ...
                                else if (dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["GCode"].ToString().Trim().Substring(0, 3) == "GRI")
                                {
                                    sb.Remove(0, sb.Length);
                                    sb.Append("Update Gatereceiptinternaldetailssub set TRFStatus='D',TRFCode='" + MTFCode.Trim() + "'  where  ");
                                    sb.Append("SerialNo='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["SerialNo"].ToString().Trim() + "' and GRICode='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["GCode"].ToString().Trim() + "' ");
                                    cmd = new SqlCommand(sb.ToString(), con);
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
                                    cmd.Dispose();
                                ...
                                else if (dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["GCode"].ToString().Trim().Substring(0, 3) == "CNS")
                                {
                                    string StrGiirCode = "0";
                                    StrGiirCode = ComCon.getTranName("select  GiirCode  From ConvertSerialNoDetails  where  CNVCode='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["GCode"].ToString().Trim() + "' and SerialNo='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["SerialNo"].ToString().Trim() + "' ", "J2", "GiirCode", con, tran);

                                    sb.Remove(0, sb.Length);
                                    sb.Append("Update GIIRDetailsSub set TRFStatus='D',TRFCode='" + MTFCode.Trim() + "'  where  ");
                                    sb.Append("SerialNo='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["SerialNo"].ToString().Trim() + "' and GIIrCode='" + StrGiirCode + "' ");
                                    cmd = new SqlCommand(sb.ToString(), con);
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
                                    cmd.Dispose();
                                    ...
                                    sb.Remove(0, sb.Length);
                                    sb.Append("Update ConvertSerialNoDetails set MTFSerialStatus='D',CMTFCode='" + MTFCode.Trim() + "'  where  ");
                                    sb.Append("SerialNo='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["SerialNo"].ToString().Trim() + "' and CNVCode='" + dsDetailsSub.Tables["tbl_MTFSrNo"].Rows[k]["GCode"].ToString().Trim() + "' ");
                                    cmd = new SqlCommand(sb.ToString(), con);
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
                                    cmd.Dispose();
                   ...
                   )
                {
                    ...
                    //Added
                    if (strEngGIIR_Memo.Trim() == "" || strAltGIIR_Memo.Trim() == "" || strBatGIIR_Memo.Trim() == "")
                    {
                        cmd.Parameters.AddWithValue("@MTFScanStatus", "D");
                    }
                    else
                    {
                    ...
                    for (int cSub_Memo = 0; cSub_Memo <= recCount_Memo; cSub_Memo++)
                    {
                        ...
                        if (Dts_Memo[1].ToString().Trim() != "" && double.Parse(Dts_Memo[1].ToString().Trim()) > 0)//IssueQty
                        {
                            ...
                            //MOB-M
                                ...
                                || Dts_Memo[0].Trim().Substring(0, 3).Trim() != "010") && (StrMOB.ToString().Trim() == "M"))
                            {
                                double IssueQty = Convert.ToDouble(Dts_Memo[1].Trim());
                                double GIIRIssue = 0;
                                ...
                                if (dsDetailsSubV_Other != null && dsDetailsSubV_Other.Tables["tbl_GIIRSrNoV"].Rows.Count > 0)
                                {
                                    ...
                                    for (int v = 0; v < dsDetailsSubV_Other.Tables["tbl_GIIRSrNoV"].Rows.Count; v++)
                                    {
                                        if (IssueQty > 0)
                                        {
                                            ...
                                            //ADD
                                            sb.Remove(0, sb.Length);
                                            sb.Append("Insert into MTFProcessDetails (MTFCODE,SrNo,PartCode,ProcessNo,MTFPQty,SerialNo,TRFPStatus) values ('" + MTFCode.Trim().Trim() + "','1', '" + Dts_Memo[0].Trim() + "','" + dsDetailsSubV_Other.Tables["tbl_GIIRSrNoV"].Rows[v]["ReceivedCode"].ToString().Trim() + "','" + GIIRIssue + "'");
                                            sb.Append(",'','P')");
                                            cmd = new SqlCommand(sb.ToString(), con);
                                            cmd.Transaction = tran;
                                            cmd.ExecuteNonQuery();
                                            ...
                                            {
                                                sb.Remove(0, sb.Length);
                                                sb.Append("UPDATE ProcessWithKit SET MTFStatus='D' WHERE PWKCode='" + dsDetailsSubV_Other.Tables["tbl_GIIRSrNoV"].Rows[v]["ReceivedCode"].ToString().Trim() + "' ");
                                                sb.Append(" AND ProcessKitCode='" + Dts_Memo[0].Trim() + "'");
                                                cmd = new SqlCommand(sb.ToString(), con);
                                                cmd.Transaction = tran;
                                                cmd.ExecuteNonQuery();
                                                cmd.Dispose();
