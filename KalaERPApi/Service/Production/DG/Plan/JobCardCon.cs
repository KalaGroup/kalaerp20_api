...
namespace KalaERPApi.Service
{
    public class JobCardCon
    {
        ...
        public string GetCPStk(string StrKVA, string ph, string PanelType, string CompId)
        {
            string CPStk = "";
            CommonCon ComCon = new CommonCon();
            if (CompId == "28")
            {
                dsDetailsSub = ComCon.procDS("exec GetCPStk_Bangalore  '" + StrKVA.Trim() + "'," + ph.Trim() + ",'" + PanelType.Trim() + "'", "tbl_JoBCardSerialNo");
            }
            else
            {
                    ...
                    if (dsDetailsSub != null && dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows.Count > 0)
                    {
                        ...
                        for (int k = 0; k < dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows.Count; k++)
                        {
                            ...
                            if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(0, 3) == "MTF" 
                                || dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(0, 3) == "CNS")
                            {
                                sb.Append("'" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim() + "','D',");
                            }
                            else if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(0, 3) == "GIR"
                                && jobreq.PCCode.Trim().Substring(0,2) == "01" && dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(10,2) == "01")
                            {
                                sb.Append("'" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim() + "','D',");
                            }
                            else if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(0, 3) == "GIR"
                               && jobreq.PCCode.Trim()== GetPOPCcode(con,tran,dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim()))
                            {
                                sb.Append("'" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim() + "','D',");
                            }
                            else 
                                ...
                                || dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["PartCode"].ToString().Trim().Substring(0, 3) == "010")
                            {
                                ...
                                else if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(0, 3) == "GRI")
                                {
                                    sb.Remove(0, sb.Length);
                                    sb.Append("Update GatereceiptInternalDetailsSub set JobCardStatus='J' where  GRICode='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim() + "' and SerialNo='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SerialNo"].ToString().Trim() + "' ");
                                    sb.Append("and PartCode='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["PartCode"].ToString().Trim() + "'");
                                    cmd = new SqlCommand(sb.ToString(), con);
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
                                ...
                                else if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim().Substring(0, 3) == "CNS")
                                {
                                    sb.Remove(0, sb.Length);
                                    sb.Append("Update ConvertSerialNoDetails set JobCardStatus='J' where  CNVCode='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim() + "' and SerialNo='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SerialNo"].ToString().Trim() + "' ");
                                    cmd = new SqlCommand(sb.ToString(), con);
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
                                    cmd.Dispose();
                                    ...
                                    string StrGirCode = "0";
                                    StrGirCode = ComCon.getTranName("select Giircode From ConvertSerialNoDetails  where  CNVCode='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["Gcode"].ToString().Trim() + "' and SerialNo='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SerialNo"].ToString().Trim() + "' ", "JB2", "Giircode", con, tran);


                                    sb.Remove(0, sb.Length);
                                    sb.Append("Update GIIRDetailsSub set JobCardStatus='J' where  GiirCode='" + StrGirCode + "' and SerialNo='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SerialNo"].ToString().Trim() + "' ");
                                    sb.Append("and PartCode='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["PartCode"].ToString().Trim() + "'");
                                    cmd = new SqlCommand(sb.ToString(), con);
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
        ...
        */
        ...
        public string Submit(JobCardRequest jobreq)
        {
            ...
            for (int cSubV = 0; cSubV <= recCountV; cSubV++)
            {
                ...
                if (double.Parse(DtsV[2].Trim()) > double.Parse(DtsV[3].Trim()))
                {
                    //JobCardNo = "Plan Qty Cannot be Greater Than TOC Qty For DG " + ComCon.getName("select partdesc From part where Partcode='" + DtsV[1].Trim() + "'", "TblPart", "Partdesc");
                    //return JobCardNo;
                }

                dsDetailsSubV = ComCon.procDS("exec GetJobCardSrNo 'DGWOP','" + DtsV[1] + "'," + DtsV[2].Trim() + ", '" + jobreq.PCCode.Trim().Substring(0, 2) + "'", "tbl_JoBCardSerialNoV");

                if (dsDetailsSubV == null)
                {
                    JobCardNo = "Job Card Details not available";
                    return JobCardNo;
                }
                ...
                if (dsDetailsSubV != null && dsDetailsSubV.Tables["tbl_JoBCardSerialNoV"].Rows.Count > 0)
                {
                    ...
                    for (int v = 0; v < dsDetailsSubV.Tables["tbl_JoBCardSerialNoV"].Rows.Count; v++)
                    {
                        ...
                        else if (dsDetailsSubV.Tables["tbl_JoBCardSerialNoV"].Rows[v]["PartCode"].ToString().Trim().Substring(0, 3).Trim() == "010")
                        {
                             strBatQty = strBatQty + 1;
                        }
                        else if (dsDetailsSubV.Tables["tbl_JoBCardSerialNoV"].Rows[v]["PartCode"].ToString().Trim().Substring(0, 2) == "40")
            ...
            try
            {
                ...
                for (int cSub = 0; cSub <= recCount; cSub++)
                {
                    ...
                    if (int.Parse(Dts[2].Trim()) > 0)
                    {

                        sb.Remove(0, sb.Length);
                        sb.Append("INSERT INTO JobCardDetails(JobCode,SrNo,BOMCode,PartCode,Qty,PlanCode,PlanDate,DayPlanQty,Stage1Status,Stage2Status,Stage3Status)");
                        sb.Append(" VALUES('" + JobCardNo.Trim() + "','" + SrNo + "','" + Dts[0].Trim() + "','" + Dts[1].Trim() + "','" + Dts[2].Trim() + "','" + Dts[4].Trim() + "', '" + Dts[5].Trim() + "', '" + Dts[6].Trim() + "', 'P','P','P')");
                        cmd = new SqlCommand(sb.ToString(), con);
                        cmd.Transaction = tran;
                        cmd.ExecuteNonQuery();
                        cmd.Dispose();
                        ...
                        if (dsDetailsSub != null && dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows.Count > 0)
                        {
                            ...
                            for (int k = 0; k < dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows.Count; k++)
                            {
                                ...
                                else if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["PartCode"].ToString().Trim().Substring(0, 3) == "010" && double.Parse(strKVA.Trim()) <= 200)
                                {
                                    JPBat = JPBat + 1;
                                }
                                else if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["PartCode"].ToString().Trim().Substring(0, 3) == "010" && double.Parse(strKVA.Trim()) > 200)
                ...
                string strReqCode = "";
                string strReqCodeAll = "";
                string GetMaxValueR = "";
                int recCountR = ComCon.CountChars(jobreq.JobCardDts, ",");
                string[] strJCDDtsR = Regex.Split(jobreq.JobCardDts, ",");
                if (jobreq.PCCode.Trim().Substring(0, 2) != "28") // condition added by KB as Wrong Requisition was raised from Bangalore to Logistics Unit which was not required on 21/11/2025
                {
                    for (int cSub = 0; cSub <= recCount; cSub++)
                    {
                        ...
                        strReqCode = "";
                        GetMaxValueR = "";
                        string[] DtsR = Regex.Split(strJCDDts[cSub].ToString().Trim(), "-->");

                        if (int.Parse(DtsR[2].Trim()) > 0)
                        {
                            GetMaxValueR = ComCon.GetMaxNo("MaterialRequisitionWithOutPlan", "REQ", jobreq.PCCode.Trim().Substring(0, 2), con, tran);
                            strReqCode = GetMaxValueR;
                            if (cSub == 0)
                            {
                                strReqCodeAll = strReqCode;
                            }
                            else
                            {
                                strReqCodeAll = strReqCodeAll + "#" + strReqCode;
                            }
                            //Mst Req
                            #region
                            cmd = new SqlCommand("insertMaterialRequisitionWithOutPlanProcessVsPlan", con);
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.AddWithValue("@REQCode", strReqCode);
                            cmd.Parameters.AddWithValue("@MaxSrNo", GetMaxValueR.Substring(10, 8).ToString());
                            ...
                            cmd.Parameters.AddWithValue("@ProfitCenterCode", jobreq.PCCode.Trim());
                            cmd.Parameters.AddWithValue("@ToProfitCenterCode", "23.001");
                            cmd.Parameters.AddWithValue("@ClassCode", DtsR[1].Trim());
                            cmd.Parameters.AddWithValue("@ActNo", DtsR[2].Trim());
                            cmd.Parameters.AddWithValue("@SourceCode", JobCardNo.Trim());
                            cmd.Parameters.AddWithValue("@CompanyCode", jobreq.PCCode.Trim().Substring(0, 2));
                            cmd.Parameters.AddWithValue("@REQStatus", "P");
                            cmd.Parameters.AddWithValue("@REQType", "WIP");
                            cmd.Parameters.AddWithValue("@Remark", "Auto Req For Plan No " + JobCardNo.Trim());
                            ...
                            dsReqDts = ComCon.procTranDS("exec InternalReqLogisticsdetailsDG  '" + DtsR[1].Trim() + "' ", "tbl_RaiseReqDts", con, tran);
                            if (dsReqDts != null && dsReqDts.Tables["tbl_RaiseReqDts"].Rows.Count > 0)
                            {
                                ...
                                for (int cntd = 0; cntd < dsReqDts.Tables["tbl_RaiseReqDts"].Rows.Count; cntd++)
                                {
                                    ...
                                    cmd.Parameters.AddWithValue("@Qty", double.Parse(dsReqDts.Tables["tbl_RaiseReqDts"].Rows[cntd]["RaiseReqQty"].ToString().Trim()) * double.Parse(DtsR[2].Trim()));
                                    cmd.Parameters.AddWithValue("@REQStatus", "P");
                                    cmd.Transaction = tran;
                                    cmd.ExecuteNonQuery();
                                    cmd.Dispose();
                            ...
                            cmd.Parameters.AddWithValue("@EmpID", "Auto Against Plan");
                    ...
                    return JobCardNo + "With Requisition No:" + strReqCodeAll;
            }
        ...
        public string GetPOPCcode(SqlConnection con, SqlTransaction tran, string GiirCode)
        {
            string POPCcode = "";
            CommonCon ComCon = new CommonCon();
            dsChkBat = ComCon.procTranDS("Select ProfitcenterCode From Giir G inner Join GiirDetails Gd on G.giircode=gd.Giircode Inner join PurchaseOrder PO On Gd.GIRDPOCode=PO.POCode Where G.GiirCode='" + GiirCode + "' Group By ProfitcenterCode ", "tbl_JoBCardBat", con, tran);
            if (dsChkBat != null && dsChkBat.Tables["tbl_JoBCardBat"].Rows.Count == 1)
            {

                POPCcode = dsChkBat.Tables["tbl_JoBCardBat"].Rows[0]["ProfitcenterCode"].ToString().Trim();
        ...
        public string Submit2(JobCard2Request jobreq2)
        {
            ...
            try
            {
                ...
                for (int cSub = 0; cSub <= recCount; cSub++)
                {
                    ...
                    if (dsDetailsSub != null && dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows.Count > 0)
                    {
                        ...
                        for (int k = 0; k < dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows.Count; k++)
                        {
                            ...
                            if (dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SrNoPartcode"].ToString().Trim().Substring(0, 5) == "00002")
                            {
                                ...
                                sb.Append("'" + ComCon.getTranName("select JobCode from JobCardDetailsSub where SerialNo in (select SerialNo from Giirdetailssub where KRMNo='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SerialNo"].ToString().Trim() + "')  ", "JobCard", "JobCode", con, tran) + "',");
                                sb.Append("'" + ComCon.getTranName("select JPriority from JobCardDetailsSub where SerialNo in (select SerialNo from Giirdetailssub where KRMNo='" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["SerialNo"].ToString().Trim() + "')  ", "JobCard", "JPriority", con, tran) + "')");
                            }
                            else
                            {
                                sb.Append("'" + dsDetailsSub.Tables["tbl_JoBCardSerialNo"].Rows[k]["JobCode"].ToString().Trim() + "',");
                    ...
                    //if (double.Parse(panelTypeId) != 0 && double.Parse(panelTypeId) != 150) Commented by KB on 16/07/2024 to allow Panel Partcode for None Panel Type.
                    if (double.Parse(panelTypeId) != 150)
                    {
                        ...
                        if (dsDetailsSubP != null && dsDetailsSubP.Tables["tbl_JoBCardEngPri"].Rows.Count > 0)
                        {
                            ...
                            {
                                //if (double.Parse(panelTypeId) != 0) Commented by KB on 16/07/2024 to allow Panel Partcode for None Panel Type.
                                if (double.Parse(panelTypeId) != 150) // Added by KB on 16/07/2024 to allow Panel Partcode for None Panel Type.
                                {
                                    if (jobreq2.PCCode.Trim().Substring(0, 2) == "28")
                                    {
                                        //dsDetailsCP = ComCon.procTranDS("exec GetCPPartcode_Bangalore " + panelTypeId + ",'0'", "tbl_JoBCardCPPart", con, tran);

                                        if (double.Parse(panelTypeId) == 0)
                                        {
                                            dsDetailsCP = ComCon.procTranDS("exec GetCPPartcode_Bangalore '0','" + Dts[1].Trim() + "'", "tbl_JoBCardCPPart", con, tran);
                                        }
                                        else
                                        {
                                            dsDetailsCP = ComCon.procTranDS("exec GetCPPartcode_Bangalore " + panelTypeId + ",'0'", "tbl_JoBCardCPPart", con, tran);
                                    ...
                                    else
                                    {
                                        if (double.Parse(panelTypeId) == 0)
                                        {
                                            dsDetailsCP = ComCon.procTranDS("exec GetCPPartcode '0','" + Dts[1].Trim() + "'", "tbl_JoBCardCPPart", con, tran);
                                        }
                                        else
                                        {
                                ...
                                if (dsDetailsCP != null && dsDetailsCP.Tables["tbl_JoBCardCPPart"].Rows.Count > 0)
                                {
                                    ...
                                    for (int p = 0; p < dsDetailsCP.Tables["tbl_JoBCardCPPart"].Rows.Count; p++)
                                    {
                                        if (jobreq2.PCCode.Trim().Substring(0, 2) == "28")
                                        {
                                            dsDetailsCPSRNo = ComCon.procTranDS("exec GetCPPartcode_Bangalore 1,'" + dsDetailsCP.Tables["tbl_JoBCardCPPart"].Rows[p]["PanelTypePartcode"].ToString().Trim() + "'", "tbl_JoBCardSerialNoCP", con, tran);
                                        }
                                        else
                                        {
                                        ...
                                        if (dsDetailsCPSRNo != null && dsDetailsCPSRNo.Tables["tbl_JoBCardSerialNoCP"].Rows.Count > 0)
                                        {
                                            ...
                                            for (int p1 = 0; p1 < dsDetailsCPSRNo.Tables["tbl_JoBCardSerialNoCP"].Rows.Count; p1++)
                                            {
                                                ...
                                                else if (dsDetailsCPSRNo.Tables["tbl_JoBCardSerialNoCP"].Rows[p1]["Gcode"].ToString().Trim().Substring(0, 3) == "GRI")
                                                {
                                                    sb.Remove(0, sb.Length);
                                                    sb.Append("Update GateReceiptInternalDetailsSub set JobCardStatus='J',TRFStatus='D' where  GriCode='" + dsDetailsCPSRNo.Tables["tbl_JoBCardSerialNoCP"].Rows[p1]["Gcode"].ToString().Trim() + "' and SerialNo='" + dsDetailsCPSRNo.Tables["tbl_JoBCardSerialNoCP"].Rows[p1]["SerialNo"].ToString().Trim() + "' ");
                                                    sb.Append("and PartCode='" + dsDetailsCPSRNo.Tables["tbl_JoBCardSerialNoCP"].Rows[p1]["PartCode"].ToString().Trim() + "'");
                                                    cmd = new SqlCommand(sb.ToString(), con);
                                                    cmd.Transaction = tran;
                                                    cmd.ExecuteNonQuery();
