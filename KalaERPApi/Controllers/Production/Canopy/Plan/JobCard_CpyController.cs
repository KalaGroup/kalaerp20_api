...
{
    public class JobCard_CpyController : ApiController
    {
        JobCard_CpyCon dc = new JobCard_CpyCon();
        DataTable ds = new DataTable();


        
        [HttpGet]
        [Route("Conopy/JobCard_Cpy/GetCpyPlan")]
        public DataTable GetCpyPlan(string CompId)
        {
            return dc.GetCpyPlan("Cpy_Plan", CompId);
        }

        [HttpPost]
        [Route("Conopy/JobCard_Cpy/Submit")]
        public string Submit([FromBody] JobCard_CpyRequest job_Cpyreq)
        {
            return dc.Submit(job_Cpyreq);
        }
        ...
        //public string GetJobCard2CP(string StrKVA,string Ph,string PanelType)
        //{
        //    return dc.GetCPStk(StrKVA,Ph,PanelType);
        //}
