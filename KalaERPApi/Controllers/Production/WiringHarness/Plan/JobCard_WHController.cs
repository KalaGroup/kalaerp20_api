...
{
    public class JobCard_WHController : ApiController
    {
        JobCard_WHCon dc = new JobCard_WHCon();
        DataTable ds = new DataTable();


        
        [HttpGet]
        [Route("Conopy/JobCard_WH/GetWHPlan")]
        public DataTable GetWHPlan(string CompId)
        {
            return dc.GetWHPlan("WH_Plan", CompId);
        }

        [HttpPost]
        [Route("Conopy/JobCard_WH/Submit")]
        public string Submit([FromBody] JobCard_CpyRequest job_WHreq)
        {
            return dc.Submit(job_WHreq);
        }
